...
3. Review Angular token storage and session handling.
4. Review avatar upload security.
5. Review avatar storage architecture and move user-uploaded avatars out of git-tracked assets.
